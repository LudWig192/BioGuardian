    ...
    return (
        <div className="grafico-container">
            <div className="grafico-header">
                <h2 className="grafico-title">
                    Salários por Profissão Médica
                    <FaSync className="toggle-icon" onClick={toggleSalario} title="Alternar Salário" />
                </h2>
                <button className="download-button" onClick={exportToExcel}>Exportar para Excel</button>
            </div>
            <p className="period">Período: 1 Março - 14 Março</p>
            ...
            <div className="analise-salarios">
                <h3>Análise de Salários</h3>
                <ul>
                    <li className="analise-item"><FaMoneyBillAlt className="money-icon" /><strong>Média Salarial:</strong> {formatCurrency(23000)}</li>
                    <li className="analise-item"><FaMoneyBillAlt className="money-icon" /><strong>Maior Salário:</strong> {formatCurrency(30000)} (Neurologista)</li>
                    <li className="analise-item"><FaMoneyBillAlt className="money-icon" /><strong>Aumento Médio:</strong> 5% em relação ao ano passado</li>
                </ul>
            </div>
        </div>
    );
