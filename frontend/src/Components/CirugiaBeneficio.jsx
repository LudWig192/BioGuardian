...
const EyeCareServices = () => {
  return (
    <div className="cirurgiabeneficio-container">
      <div className="cirurgiabeneficio-text">
        <div className="cirurgiabeneficio-main-title">
          Nossas Cirurgias
        </div>
        ...
        <div className="cirurgiabeneficio-features">
          <div className="cirurgiabeneficio-feature">
            ...
            <div className="cirurgiabeneficio-feature-text">
              <div className="cirurgiabeneficio-card-title">
                BioGuardian
              </div>
      ...
      <div className="cirurgiabeneficio-eye-care-image">
